...
driver = webdriver.Chrome(executable_path='C:/Users/Prince/Desktop/my code goes here/selenium/real data/chromedriver.exe',chrome_options=chrome_options)
print('getting page')
...
if(d0==date(2019,3,1)):
	...
	for i in range(10):
		try:
			...
			driver.find_element_by_css_selector('input[placeholder="Nickname or email"]').send_keys(username)
